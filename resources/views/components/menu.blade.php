...
<div class="menu">
    ...
    <ul class="menu-admin">
        ...
        <!-- GESTIÓN DE ROLES - SECCIÓN ACTUALIZADA -->
        <li>
            <a href="{{ route('roles.index') }}">
                <i class="bx bx-user-id-card"></i> Gestión de Roles
            </a>
            <ul class="submenu">
                <li><a href="{{ route('roles.create') }}">Crear nuevo rol</a></li>
                <li><a href="{{ route('roles.index') }}">Editar nombre o descripción</a></li>
                <li><a href="{{ route('roles.index') }}">Eliminar rol</a></li>
            </ul>
        </li>
